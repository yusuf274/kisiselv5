...
$kullanicidsi=$yonetim->kulidal($baglanti);
        ...
        if($_FILES["resimyol"]["name"]==""){
            ...
            if($_FILES["resimyol"]["size"]>(1024*1024*5)){
                ...
                if(!in_array($_FILES["resimyol"]["type"],$izinverilen)){
                    ...
                    $dosyayaeris = $baglanti->prepare("select * from admins where id=$kullanicidsi ");
                    $dosyayaeris->execute();
                    $dosyayaerisal = $dosyayaeris->fetch();
                    $resimyolu=$dosyayaerisal["resim"];
                    ...
                    $resimiguncelle=$baglanti->prepare("update admins set resim='$veritabaniicin' where id=$kullanicidsi");
...
$ayarcek = $baglanti->prepare("SELECT * from admins where id=$kullanicidsi");
$ayarcek->execute();
                            ...
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <img style="width: 200px;height: 200px" class=""  src="../<?php echo $ayarlar["resim"]; ?>">
                                        <br><br>
