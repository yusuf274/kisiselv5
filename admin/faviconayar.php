        ...
        if($_FILES["resimyol"]["name"]==""){
            ...
            if($_FILES["resimyol"]["size"]>(1024*1024*5)){
                ...
                if(!in_array($_FILES["resimyol"]["type"],$izinverilen)){
                    ...
                    $resimyolu=$dosyayaerisal["faviconyol"];
                    ...
                    $resimiguncelle=$baglanti->prepare("update ayar set faviconyol='$veritabaniicin'");
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="card-body">
                            ...
                            <p class="text-danger">*Lütfen 50px genişlik 50px yüksekliğinde foto yükleyiniz.kare formatına yakın </p>
                            <br>
                            ...
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left">
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Faviconresim <span class="required">*</span>
                                    </label>


                                    <div class="col-md-6 col-sm-6 col-xs-12">

                                        <img style="width: 200px;height: 200px" class=""  src="../<?php echo $ayarlar["faviconyol"]; ?>">
                                        <br><br>
